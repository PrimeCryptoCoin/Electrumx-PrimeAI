...
latex_documents = [
    (master_doc, 'ElectrumX.tex', 'ElectrumX Primeai Documentation',
...
man_pages = [
    (master_doc, 'electrumx', 'ElectrumX Primeai Documentation',
     [author], 1)
]
