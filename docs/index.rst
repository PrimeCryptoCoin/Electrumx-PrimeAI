...
The project is hosted on `GitHub <https://github.com/PrimeaiProject/electrumx-primeai>`_.

Please submit an issue on the `bug tracker
<https://github.com/PrimeaiProject/electrumx-primeai/issues>`_ if you have found a
...
<https://github.com/PrimeaiProject/electrumx-primeai/LICENCE>`_.
